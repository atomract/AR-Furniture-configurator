...
export function Model(props) {
  ...
  return (
    <group scale={isPresenting ? [0.75,2.4,0.75] : [0.84, 0.84,0.84]} position={isPresenting ? [0,-4.1,-3.2] : [0,-0.38,0]} rotation={isPresenting ? [0,0,0] : [Math.PI/5,0,0]} {...props} dispose={null}>
